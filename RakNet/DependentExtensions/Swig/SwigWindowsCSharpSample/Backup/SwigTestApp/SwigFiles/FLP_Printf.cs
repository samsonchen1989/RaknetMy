...
public class FLP_Printf : FileListProgress {
  ...
  internal FLP_Printf(global::System.IntPtr cPtr, bool cMemoryOwn) : base(RakNetPINVOKE.FLP_Printf_SWIGUpcast(cPtr), cMemoryOwn) {
  ...
  public new static FLP_Printf GetInstance() {
    global::System.IntPtr cPtr = RakNetPINVOKE.FLP_Printf_GetInstance();

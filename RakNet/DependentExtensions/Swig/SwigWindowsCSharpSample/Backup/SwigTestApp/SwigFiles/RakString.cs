...
public class RakString : global::System.IDisposable {
  ...
  public class SharedString : global::System.IDisposable {
    ...
    public virtual void Dispose() {
      lock(this) {
        if (swigCPtr.Handle != global::System.IntPtr.Zero) {
          if (swigCMemOwn) {
            swigCMemOwn = false;
            RakNetPINVOKE.delete_RakString_SharedString(swigCPtr);
          }
          swigCPtr = new global::System.Runtime.InteropServices.HandleRef(null, global::System.IntPtr.Zero);
        }
        global::System.GC.SuppressFinalize(this);
    ...
    public SimpleMutex refCountMutex {
      set {
        RakNetPINVOKE.RakString_SharedString_refCountMutex_set(swigCPtr, SimpleMutex.getCPtr(value));
      } 
      get {
        global::System.IntPtr cPtr = RakNetPINVOKE.RakString_SharedString_refCountMutex_get(swigCPtr);
    ...
    public uint refCount {
      set {
        RakNetPINVOKE.RakString_SharedString_refCount_set(swigCPtr, value);
      } 
      get {
        uint ret = RakNetPINVOKE.RakString_SharedString_refCount_get(swigCPtr);
        return ret;
      } 
    }
    ...
    public uint bytesUsed {
      set {
        RakNetPINVOKE.RakString_SharedString_bytesUsed_set(swigCPtr, value);
      } 
      get {
        uint ret = RakNetPINVOKE.RakString_SharedString_bytesUsed_get(swigCPtr);
        return ret;
      } 
    }
    ...
    public string bigString {
      set {
        RakNetPINVOKE.RakString_SharedString_bigString_set(swigCPtr, value);
      } 
      get {
        string ret = RakNetPINVOKE.RakString_SharedString_bigString_get(swigCPtr);
        return ret;
      } 
    }
    ...
    public string c_str {
      set {
        RakNetPINVOKE.RakString_SharedString_c_str_set(swigCPtr, value);
      } 
      get {
        string ret = RakNetPINVOKE.RakString_SharedString_c_str_get(swigCPtr);
        return ret;
      } 
    }
    ...
    public string smallString {
      set {
        RakNetPINVOKE.RakString_SharedString_smallString_set(swigCPtr, value);
      } 
      get {
        string ret = RakNetPINVOKE.RakString_SharedString_smallString_get(swigCPtr);
        return ret;
      } 
    }
  
    public SharedString() : this(RakNetPINVOKE.new_RakString_SharedString(), true) {
    }

...
public class RakPeerInterface : global::System.IDisposable {
  ...
  public static RakPeerInterface GetInstance() {
    global::System.IntPtr cPtr = RakNetPINVOKE.RakPeerInterface_GetInstance();
  ...
  public virtual Packet Receive() {
    global::System.IntPtr cPtr = RakNetPINVOKE.RakPeerInterface_Receive(swigCPtr);
  ...
  public virtual Packet AllocatePacket(uint dataSize) {
    global::System.IntPtr cPtr = RakNetPINVOKE.RakPeerInterface_AllocatePacket(swigCPtr, dataSize);
    Packet ret = (cPtr == global::System.IntPtr.Zero) ? null : new Packet(cPtr, false);
    return ret;
  }
  ...
  public virtual RakNetStatistics GetStatistics(SystemAddress systemAddress, RakNetStatistics rns) {
    global::System.IntPtr cPtr = RakNetPINVOKE.RakPeerInterface_GetStatistics__SWIG_0(swigCPtr, SystemAddress.getCPtr(systemAddress), RakNetStatistics.getCPtr(rns));
  ...
  public virtual RakNetStatistics GetStatistics(SystemAddress systemAddress) {
    global::System.IntPtr cPtr = RakNetPINVOKE.RakPeerInterface_GetStatistics__SWIG_1(swigCPtr, SystemAddress.getCPtr(systemAddress));
    RakNetStatistics ret = (cPtr == global::System.IntPtr.Zero) ? null : new RakNetStatistics(cPtr, false);
    if (RakNetPINVOKE.SWIGPendingException.Pending) throw RakNetPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

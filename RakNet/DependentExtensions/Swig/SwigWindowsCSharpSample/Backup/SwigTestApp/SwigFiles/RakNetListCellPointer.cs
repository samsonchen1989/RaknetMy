...
public class RakNetListCellPointer : global::System.IDisposable {
  ...
  public Cell GetHelper(uint position) {
    global::System.IntPtr cPtr = RakNetPINVOKE.RakNetListCellPointer_GetHelper(swigCPtr, position);
    Cell ret = (cPtr == global::System.IntPtr.Zero) ? null : new Cell(cPtr, false);
    return ret;
  }

  public Cell PopHelper() {
    global::System.IntPtr cPtr = RakNetPINVOKE.RakNetListCellPointer_PopHelper(swigCPtr);
    Cell ret = (cPtr == global::System.IntPtr.Zero) ? null : new Cell(cPtr, false);
    return ret;
  }
